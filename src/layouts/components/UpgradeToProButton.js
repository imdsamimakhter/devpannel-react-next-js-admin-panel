...
const BuyNowButton = () => {
  ...
  return (
    <Box
      ...
      sx={{ right: theme => theme.spacing(20), bottom: theme => theme.spacing(10), zIndex: 11, position: 'fixed', visibility: 'hidden' }}
    >
        ...
        >
          <Paper elevation={9} sx={{ borderRadius: 1, overflow: 'hidden' }}>
            ...
            <CardContent>
              ...
              DevPannel - React Admin Template
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
              DevPannel Admin is the most developer friendly & highly customizable Admin Dashboard Template based on MUI
                and NextJS.
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
